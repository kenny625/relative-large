$(document).ready(function () {
    ...
    $('#keyboard li').hover(function () {
        ...
        $class = $(this).attr('class');
        /*         console.log($class); */
        $enlargeLetter2 = '<li id="enlargeLetter2" class="' + $class + ' leap-interactive tapper"' + ">" + $(this).html() + "</li>";
        $($enlargeLetter2).insertAfter(this);
        $left = $(this).position().left - 10;
        $top = $(this).position().top - 10+90;
        $width = $(this).width() + 20;
        $height = $(this).height() + 20;
        //        console.log("left "+$left+" top "+$top);
        $('#enlargeLetter2').css({
...
function leapToScene(frame, leapPos) {
    ...
    var left = iBox.center[0] - iBox.size[0] / 2 * 2;
    var top = iBox.center[1] + iBox.size[1] / 2 * 2;
